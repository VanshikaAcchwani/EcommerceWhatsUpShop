					...
					<div style="display: table-row; height: 100%;">
						<div class="adminmenubar">
							<div class="stickythingy">
								...
								<!--<div style="text-align: center; padding: 30px; font-size: 10px;"><?php //echo uilang("Developed by"); ?><br><a target="_blank" class="textlink" style="color: lime;" href="https://swaass.com">https://swaass.com</a></div>-->
							</div>
						</div>
						<div style="display: table-cell; padding: 25px; vertical-align: top; border-left: 1px solid <?php echo $maincolor ?>; ">
							...
							//settings
								...
								if(isset($_POST["websitetitle"])){
									...
									$cfg->email_id = mysqli_real_escape_string($connection, $_POST["email_id"]);
								...
								<form method="post" enctype="multipart/form-data">
									...
									<input placeholder="Email Id" name="email_id" value="<?php echo $cfg->email_id ?>">
